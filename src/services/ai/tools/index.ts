...
import type { DEFINE_SETTINGS_INTENT_TOOL } from "./define-settings-intent/definition.ts";
import type { GET_SETTINGS_TOOL } from "./get-settings/definition.ts";
...
import type { UPDATE_CRON_JOB_TOOL } from "./update-cron-job/definition.ts";
import type { UPDATE_SETTINGS_TOOL } from "./update-settings/definition.ts";
...
export type TTools =
  ...
  | typeof DEFINE_SETTINGS_INTENT_TOOL
  | typeof GET_SETTINGS_TOOL
  ...
  | typeof UPDATE_CRON_JOB_TOOL
  | typeof UPDATE_SETTINGS_TOOL
